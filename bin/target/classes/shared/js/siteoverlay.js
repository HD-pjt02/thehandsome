 ...
 **/
 ...
 function n_so_logging(x,y,w) 
 {
     ...
     if ( typeof(_n_use_logging_server) == "undefined" || _n_use_logging_server ) {
         ...
         var _n_request = (_n_so_request==null) ? document.location.protocol + "//" + document.domain + "/_ui/wloso.html" : _n_so_request;
         ...
         var _n_target_url = "/_ui/wloso.html?wlo_so=" + encodeURIComponent(_n_so_value) + "&dv=" + Math.random();
     }
