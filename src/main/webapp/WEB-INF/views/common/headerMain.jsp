										...
										<li><strong>여성 브랜드</strong>
											<ul class="clearfix">
												...
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR03"
													...
													for="gnb_br_NEW_NORMAL_BRANDS_WE_BR03"></label>  <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=SYSTEM&pageNo=1'>SYSTEM</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR04"
													...
													for="gnb_br_NEW_NORMAL_BRANDS_WE_BR04"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=SJSJ&pageNo=1'>SJSJ</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR08"
													name="gnb_br_ch" type="checkbox" class="checkboxEvent"
													title="the CASHMERE"
													onclick="GA_Common('WE_brandLike',$(this));"
													value="NEW_NORMAL_BRANDS_WE#BR08#6"> <label
													for="gnb_br_NEW_NORMAL_BRANDS_WE_BR08"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=THE CASHMERE&pageNo=1'>the CASHMERE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR44"
													name="gnb_br_ch" type="checkbox" class="checkboxEvent"
													title="CLUB MONACO"
													onclick="GA_Common('WE_brandLike',$(this));"
													value="NEW_NORMAL_BRANDS_WE#BR44#7"> <label
													for="gnb_br_NEW_NORMAL_BRANDS_WE_BR44"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=CLUB MONACO&pageNo=1'>CLUB MONACO</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR43"
													...
													for="gnb_br_NEW_NORMAL_BRANDS_WE_BR43"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=OBZEE&pageNo=1'>OBZEE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR45"
													...
													for="gnb_br_NEW_NORMAL_BRANDS_WE_BR45"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=O%272nd&pageNo=1'>O'2nd</a></li>
											</ul></li>
										<li><strong>남성 브랜드</strong>
											<ul class="clearfix">
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ME_BR06"
													...
													for="gnb_br_NEW_NORMAL_BRANDS_ME_BR06"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=TIME HOMME&pageNo=1'>TIME HOMME</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ME_BR07"
													name="gnb_br_ch" type="checkbox" class="checkboxEvent"
													title="SYSTEM HOMME"
													onclick="GA_Common('ME_brandLike',$(this));"
													value="NEW_NORMAL_BRANDS_ME#BR07#2"> <label
													for="gnb_br_NEW_NORMAL_BRANDS_ME_BR07"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=SYSTEM HOMME&pageNo=1'>SYSTEM HOMME</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ME_BR08"
													name="gnb_br_ch" type="checkbox" class="checkboxEvent"
													title="the CASHMERE"
													onclick="GA_Common('ME_brandLike',$(this));"
													value="NEW_NORMAL_BRANDS_ME#BR08#3"> <label
													for="gnb_br_NEW_NORMAL_BRANDS_ME_BR08"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=the CASHMERE&pageNo=1'>the CASHMERE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ME_BR44"
													name="gnb_br_ch" type="checkbox" class="checkboxEvent"
													title="CLUB MONACO"
													onclick="GA_Common('ME_brandLike',$(this));"
													value="NEW_NORMAL_BRANDS_ME#BR44#4"> <label
													for="gnb_br_NEW_NORMAL_BRANDS_ME_BR44"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=CLUB MONACO&pageNo=1'>CLUB MONACO</a></li>
												<li class="oera"><input
													...
													for="gnb_br_NEW_NORMAL_BRANDS_ME_BR63"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=LANVIN BLANC&pageNo=1'> LANVIN BLANC <i class="ico-new">new</i>
												</a></li>
											</ul></li>
										<li><strong>편집 브랜드</strong>
											<ul class="clearfix">
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR15"
													...
													for="gnb_br_NEW_NORMAL_BRANDS_ED_BR15"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=TOM GREYHOUND&pageNo=1'>TOM GREYHOUND</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR35"
													name="gnb_br_ch" type="checkbox" class="checkboxEvent"
													title="FOURM THE STORE"
													onclick="GA_Common('ED_brandLike',$(this));"
													value="NEW_NORMAL_BRANDS_ED#BR35#2"> <label
													for="gnb_br_NEW_NORMAL_BRANDS_ED_BR35"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=FOURM THE STORE&pageNo=1'>FOURM THE STORE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR30"
													name="gnb_br_ch" type="checkbox" class="checkboxEvent"
													title="FOURM STUDIO"
													onclick="GA_Common('ED_brandLike',$(this));"
													value="NEW_NORMAL_BRANDS_ED#BR30#3"> <label
													for="gnb_br_NEW_NORMAL_BRANDS_ED_BR30"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=FOURM STUDIO&pageNo=1'>FOURM STUDIO</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR32"
													name="gnb_br_ch" type="checkbox" class="checkboxEvent"
													title="FOURM MEN'S LOUNGE"
													onclick="GA_Common('ED_brandLike',$(this));"
													value="NEW_NORMAL_BRANDS_ED#BR32#4"> <label
													for="gnb_br_NEW_NORMAL_BRANDS_ED_BR32"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=FOURM MEN%27S LOUNGE&pageNo=1'>FOURM MEN'S LOUNGE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR16"
													...
													for="gnb_br_NEW_NORMAL_BRANDS_ED_BR16"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=MUE&pageNo=1'>MUE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR47"
													name="gnb_br_ch" type="checkbox" class="checkboxEvent"
													title="H : SCENE"
													onclick="GA_Common('ED_brandLike',$(this));"
													value="NEW_NORMAL_BRANDS_ED#BR47#6"> <label
													for="gnb_br_NEW_NORMAL_BRANDS_ED_BR47"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=H : SCENE&pageNo=1'>H : SCENE</a></li>
											</ul></li>
										<li><strong>해외 브랜드</strong>
											<ul class="clearfix">
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_OS_BR37"
													...
													for="gnb_br_NEW_NORMAL_BRANDS_OS_BR37"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=ROCHAS&pageNo=1'>ROCHAS</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_OS_BR41"
													...
													for="gnb_br_NEW_NORMAL_BRANDS_OS_BR41"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=3.1 Phillip Lim&pageNo=1'>3.1 Phillip Lim</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_OS_BR20"
													name="gnb_br_ch" type="checkbox" class="checkboxEvent"
													title="LANVIN PARIS"
													onclick="GA_Common('OS_brandLike',$(this));"
													value="NEW_NORMAL_BRANDS_OS#BR20#4"> <label
													for="gnb_br_NEW_NORMAL_BRANDS_OS_BR20"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=LANVIN PARIS&pageNo=1'>LANVIN PARIS</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_OS_BR21"
													...
													for="gnb_br_NEW_NORMAL_BRANDS_OS_BR21"></label> <a href='${pageContext.request.contextPath}/product/brandproductlist?bname=BALLY&pageNo=1'>BALLY</a></li>
											</ul></li>
										<!-- #1141 - 카테고리 개편 - 메인 즐겨찾기 브랜드 레이어 -->
									</ul>
									<!-- 신미림 로그인 로그아웃 처리 -->
