...
<html lang="ko"><head>
    ...
    <script type="text/javascript">
            ...
            var ACC = { config: {} };
                ...
                ACC.config.CSRFToken = "66335bfb-cbb1-4642-8c59-fc8cc8614275";
    ...
    <script type="text/javascript" src="../../../resources/js/handsome/html5shiv-printshiv.js"></script>
    <script type="text/javascript" src="../../../resources/js/handsome/jquery.flexslider.js"></script>
    <script type="text/javascript" src="../../../resources/js/handsome/ui.js?20211105"></script>
    ...
    var setDimensionData = function(){
        ...
        var pageviewObj = new Object();
         ...
         //로그인 했을경우만 추가 dimension 세팅
           ...
           pageviewObj.dimension14 = "20221011";                //고객_회원가입일
    ...
    //     var startDate = new Date('2018/03/23 00:00:00'), endDate = new Date('2018/04/08 23:59:59');
        if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
            ...
            var referer = "https://www.thehandsome.com/ko/mypage/personInfomationChangePWCheck";
        ...
        if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
            ...
            var uid = "hsPersonInfomationChangePage";
    ...
    try{
        var birthday = 'Fri Mar 24 00:00:00 UTC 1995';
    ...
    <!-- Groobee -->
        ...
        <!-- End of Groobee -->
        <meta property="groobee:member_id" content="bbaksso0324@gmail.com">
        ...
        <meta property="groobee:member_age" content="28">
        <script>
        // 검색 결과 페이지
        if(window.location.pathname.indexOf("/hssearch/searchCount") > -1) {
    ...
    <link rel="stylesheet" type="text/css" href="//code.jquery.com/ui/1.12.1/themes/smoothness/jquery-ui.css"><link rel="stylesheet" type="text/css" href="//static.groobee.io/dist/g2/css/grb-recommend-list_v2.css"></head>
    ...
    // 								html.push('<li><a href="http://www.thehyundai.com/front/dpm/myShopHome.thd?bfp=Ref_Handsome">트렌드샵</a></li>');
        ...
        <form id="CSRFForm" action="/ko/mypage/personInfomationChange" method="post"><div>
    <input type="hidden" name="CSRFToken" value="66335bfb-cbb1-4642-8c59-fc8cc8614275">
    </div></form><!-- headerWrap -->
            <div id="headerWrap">
    ...
    function callChatbot(token, talkId) {
        if(token == null) {
            $.ajax({
                ...
                data: {"CSRFToken":"66335bfb-cbb1-4642-8c59-fc8cc8614275"},
                async : false,
                success:function(data){
    ...
    <script type="text/javascript" src="../../../resources/wisenut/ark/js/beta.fix.js"></script>
    ...
    $(document).ready(function() {
        ...
        //vip 채팅 서비스
        if("PASS" != ""){
            var pag = "hsPersonInfomationChangePage";
            ...
            if ((vipPassCheck == "Y" || timePassCheck == "Y") && "hsPersonInfomationChangePage" == "main201903Page") {
                $('#chatbotMain').show(); 
            }else{
                $('#chatbotMain').hide(); 
            }
                        ...
                        <div class="data_react">
                            ...
                            <div class="search_tab">
                                ...
                                <div class="recent_search s_tab">
                                    <ul id="mykeyword"><li class="searchkey"><a href="javascript:void(0);" onclick="javascript:doKeyword('[HOUSE DOCTOR] 화분');GA_Event('검색','최근검색어','%5BHOUSE%20DOCTOR%5D%20%uD654%uBD84' );">[HOUSE DOCTOR] 화분</a> <a href="javascript:removeMyKeyword('[HOUSE DOCTOR] 화분')" class="btn_close">삭제</a></li><li class="searchkey"><a href="javascript:void(0);" onclick="javascript:doKeyword('[TRUE GRACE] 오크나무 플린트');GA_Event('검색','최근검색어','%5BTRUE%20GRACE%5D%20%uC624%uD06C%uB098%uBB34%20%uD50C%uB9B0%uD2B8' );">[TRUE GRACE] 오크나무 플린트</a> <a href="javascript:removeMyKeyword('[TRUE GRACE] 오크나무 플린트')" class="btn_close">삭제</a></li><li class="searchkey"><a href="javascript:void(0);" onclick="javascript:doKeyword('롤 린트롤러 리필');GA_Event('검색','최근검색어','%uB864%20%uB9B0%uD2B8%uB864%uB7EC%20%uB9AC%uD544' );">롤 린트롤러 리필</a> <a href="javascript:removeMyKeyword('롤 린트롤러 리필')" class="btn_close">삭제</a></li><li class="searchkey"><a href="javascript:void(0);" onclick="javascript:doKeyword('[가기] 백자 미니 화병');GA_Event('검색','최근검색어','%5B%uAC00%uAE30%5D%20%uBC31%uC790%20%uBBF8%uB2C8%20%uD654%uBCD1' );">[가기] 백자 미니 화병</a> <a href="javascript:removeMyKeyword('[가기] 백자 미니 화병')" class="btn_close">삭제</a></li><li class="searchkey"><a href="javascript:void(0);" onclick="javascript:doKeyword('[GENEVA] 투어링 스몰 블루투스 스피커');GA_Event('검색','최근검색어','%5BGENEVA%5D%20%uD22C%uC5B4%uB9C1%20%uC2A4%uBAB0%20%uBE14%uB8E8%uD22C%uC2A4%20%uC2A4%uD53C%uCEE4' );">[GENEVA] 투어링 스몰 블루투스 스피커</a> <a href="javascript:removeMyKeyword('[GENEVA] 투어링 스몰 블루투스 스피커')" class="btn_close">삭제</a></li><li class="searchkey"><a href="javascript:void(0);" onclick="javascript:doKeyword('[GENEVA] 어쿠스티카 라운지 스피커');GA_Event('검색','최근검색어','%5BGENEVA%5D%20%uC5B4%uCFE0%uC2A4%uD2F0%uCE74%20%uB77C%uC6B4%uC9C0%20%uC2A4%uD53C%uCEE4' );">[GENEVA] 어쿠스티카 라운지 스피커</a> <a href="javascript:removeMyKeyword('[GENEVA] 어쿠스티카 라운지 스피커')" class="btn_close">삭제</a></li><li class="searchkey"><a href="javascript:void(0);" onclick="javascript:doKeyword('[GENEVA] 투어링 라지 블루투스 스피커');GA_Event('검색','최근검색어','%5BGENEVA%5D%20%uD22C%uC5B4%uB9C1%20%uB77C%uC9C0%20%uBE14%uB8E8%uD22C%uC2A4%20%uC2A4%uD53C%uCEE4' );">[GENEVA] 투어링 라지 블루투스 스피커</a> <a href="javascript:removeMyKeyword('[GENEVA] 투어링 라지 블루투스 스피커')" class="btn_close">삭제</a></li><div class="clear_search_hs"><a href="javascript:removeAllMyKeyword()">검색기록전체삭제</a></div></ul>
                                </div>
                                <!-- style search -->
                                <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                    <input type="hidden" name="query" value="">
                                    <input type="hidden" name="collection" value="">
                                    <input type="hidden" id="CSRFToken" name="CSRFToken" value="66335bfb-cbb1-4642-8c59-fc8cc8614275">
    ...
    <input type="hidden" name="CSRFToken" value="66335bfb-cbb1-4642-8c59-fc8cc8614275">
        ...
        <div class="util_menu util_menu1803">
            <ul class="clearfix">
                ...
                <li><a href="/mypage/myWish" onclick="GA_Event('공통','유틸_메뉴','위시리스트');"><span class="ico wishlist">wish list</span> <span class="count">(<span id="wishlistCount">0</span>)</span></a></li>
                <li><a href="/mypage/shoppingbag" onclick="GA_Event('공통','유틸_메뉴','쇼핑백');"><span class="ico cart">장바구니</span> <span class="count">(<span id="cartCount">2</span>)</span></a></li>
                </ul>
        </div>
      </div>  
        <!-- //201803 util menu -->
