...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "77badcd5-86c7-4e47-8c1f-0663967bf7b6";
...
function getGAPageTitle(oneDepthPage){
    ...
    if(target_url.substring(target_url.indexOf("/ko/")+4) == ""){
        ...
        returnTitle = oneDepthPage+">MN2C8WJC026WP_CM";
    }else if(target_url.indexOf("/c/BR02/BR02") > -1){
        returnTitle = "브랜드>MINE>전체보기";
    }else if(target_url.indexOf("/b/fourmMain") > -1){
        returnTitle = oneDepthPage+">FOURM 메인";
    }else if(target_url.indexOf("/b/storeInformation") > -1){
        returnTitle = oneDepthPage;
    }else if(target_url.indexOf("/b/BR02/brand") > -1){
        returnTitle = oneDepthPage+">MINE>소개";
    }else if(target_url.indexOf("/b/BR02/storeInformation") > -1){
        returnTitle = oneDepthPage+">MINE>매장";
    ...
    }else if(target_url.indexOf("/b/BR02/lookBookDetail?lookBookCode=") > -1){
        returnTitle = oneDepthPage+">MINE>룩북>";
    }else if(target_url.indexOf("/b/BR02/lookBook") > -1){
        returnTitle = oneDepthPage+">MINE>룩북";
    }else if(target_url.indexOf("/b/BR02") > -1){
        returnTitle = oneDepthPage+">MINE>브랜드 메인";
    }else if(target_url.indexOf("/c/WE051/ou") > -1){
    	returnTitle = oneDepthPage;
    ...
    }else if(target_url.indexOf("/c/WE051/BR02") > -1){
    	returnTitle = oneDepthPage;    	
        
    }else if(target_url.indexOf("/c/WE051") > -1){
    	returnTitle = oneDepthPage;    	
        ...
        returnTitle = oneDepthPage+">메인";
    }else if(target_url.indexOf("/c/ou_BR02/ou") > -1){
        returnTitle = oneDepthPage+">MINE";
    }else if(target_url.indexOf("/mobilecommon/search") > -1){
...
//     var startDate = new Date('2018/03/23 00:00:00'), endDate = new Date('2018/04/08 23:59:59');
    if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
        ...
        var type = "";
            ...
            if(ranBannerIdx == 3 || ranBannerIdx % 2 == 1) {  //1,3,5
                ranYn = true;
            }
            viewYn = true;
            type = "productDetail";
        ...
        var referer = "http://www.thehandsome.com/ko/c/we051/";
...
try{
	...
	recoPick('service', 'thehandsome.com/ko/');   
	   // recoPick('sendLog','view', {id:'상품id', c1:'카테고리(대)', c2:'카테고리(중)', c3:'카테고리(소)'}); 
	    var productId = "MN2C8WJC026WP";

	    var url = "http://www.thehandsome.com/ko/HANDSOME/WOMEN/OUTER/JACKET/%EC%BA%90%EC%8B%9C%EB%AF%B8%EC%96%B4-%EB%8D%94%EB%B8%94-%EC%9E%AC%ED%82%B7/p/MN2C8WJC026WP_CM";
	    var splitUrl = url.split("/");
	    
	    try{
	        recoPick('sendLog','view', {id:productId, c1:splitUrl[6], c2:splitUrl[7], c3:splitUrl[8]});
	    }catch(e) {
	        console.log(e);
	    }
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"77badcd5-86c7-4e47-8c1f-0663967bf7b6"},
            async : false,
            success:function(data){
...
$(document).ready(function() {
    ...
    if("" != ""){
	    ...
	    if ((vipPassCheck == "Y" || timePassCheck == "Y") && "hsProductDetailPage" == "main201903Page") {
	        $('#chatbotMain').show(); 
	    }else{
	        $('#chatbotMain').hide(); 
	    }
			...
			<div class="gnbwarp com clearfix">
				...
				<div class="gnb_nav gnb_nav1903 hscene1906 hscene1910">
					...
					<ul class="cate_m cate_banner gnbul1" id="cate_m_main">
										...
										<li><strong>여성 브랜드</strong>
											<ul class="clearfix">
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR01"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=TIME&pageNo=1'>
														TIME</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR02"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=MINE&pageNo=1'>
														MINE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR19"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=LANVIN COLLECTION&pageNo=1'>
														LANVIN COLLECTION</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR03"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=SYSTEM&pageNo=1'>SYSTEM</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR04"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=SJSJ&pageNo=1'>SJSJ</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR08"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=THE CASHMERE&pageNo=1'>the
														CASHMERE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR44"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=CLUB MONACO&pageNo=1'>CLUB
														MONACO</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR43"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=OBZEE&pageNo=1'>OBZEE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR45"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=O%272nd&pageNo=1'>O'2nd</a></li>
											</ul></li>
										<li><strong>남성 브랜드</strong>
											<ul class="clearfix">
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ME_BR06"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=TIME HOMME&pageNo=1'>TIME
														HOMME</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ME_BR07"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=SYSTEM HOMME&pageNo=1'>SYSTEM
														HOMME</a></li>
												...
												<li class="oera"><input
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=LANVIN BLANC&pageNo=1'>
														LANVIN BLANC <i class="ico-new">new</i>
												</a></li>
											</ul></li>
										<li><strong>편집 브랜드</strong>
											<ul class="clearfix">
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR15"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=TOM GREYHOUND&pageNo=1'>TOM
														GREYHOUND</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR35"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=FOURM THE STORE&pageNo=1'>FOURM
														THE STORE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR30"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=FOURM STUDIO&pageNo=1'>FOURM
														STUDIO</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR32"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=FOURM MEN%27S LOUNGE&pageNo=1'>FOURM
														MEN'S LOUNGE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR16"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=MUE&pageNo=1'>MUE</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR47"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=H : SCENE&pageNo=1'>H
														: SCENE</a></li>
											</ul></li>
										<li><strong>해외 브랜드</strong>
											<ul class="clearfix">
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_OS_BR37"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=ROCHAS&pageNo=1'>ROCHAS</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_OS_BR41"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=3.1 Phillip Lim&pageNo=1'>3.1
														Phillip Lim</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_OS_BR20"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=LANVIN PARIS&pageNo=1'>LANVIN
														PARIS</a></li>
												<li><input id="gnb_br_NEW_NORMAL_BRANDS_OS_BR21"
													...
													href='${pageContext.request.contextPath}/product/brandproductlist?bname=BALLY&pageNo=1'>BALLY</a></li>
											</ul></li>
										<!-- #1141 - 카테고리 개편 - 메인 즐겨찾기 브랜드 레이어 -->
									</ul>
						...
						<li><a
							href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=none&csmall=none&pageNo=1'>여성
							...
							<div class="sub_back">
								<div class="sub_menu clearfix">
									<ul class="al_frt1">
										...
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=아우터&csmall=none&pageNo=1'>아우터</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=아우터&csmall=재킷&pageNo=1'>재킷</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=아우터&csmall=점퍼&pageNo=1'>점퍼</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=아우터&csmall=가디건/베스트&pageNo=1'>가디건/베스트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=아우터&csmall=트렌치 코트&pageNo=1'>트렌치코트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=아우터&csmall=코트&pageNo=1'>코트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=아우터&csmall=다운/패딩&pageNo=1'>다운/패딩</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=탑&csmall=none&pageNo=1'>탑</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=탑&csmall=티셔츠&pageNo=1'>티셔츠</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=탑&csmall=블라우스&pageNo=1'>블라우스</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=탑&csmall=셔츠&pageNo=1'>셔츠</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=탑&csmall=니트&pageNo=1'>니트</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=드레스&csmall=none&pageNo=1'>드레스</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=드레스&csmall=미니 드레스&pageNo=1'>미니
														드레스</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=드레스&csmall=미디 드레스&pageNo=1'>미디
														드레스</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=드레스&csmall=롱/맥시 드레스&pageNo=1'></a>롱/맥시
													드레스</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=팬츠&csmall=none&pageNo=1'>팬츠</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=팬츠&csmall=캐주얼&pageNo=1'>캐주얼</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=팬츠&csmall=포멀&pageNo=1'>포멀</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=팬츠&csmall=데님&pageNo=1'>데님</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=팬츠&csmall=쇼츠&pageNo=1'>쇼츠</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li style="margin-right: 0px"><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=스커트&csmall=none&pageNo=1'>스커트</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=스커트&csmall=미니 스커트&pageNo=1'>미니
														스커트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=스커트&csmall=펜슬 스커트&pageNo=1'>펜슬
														스커트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=스커트&csmall=플레어 스커트&pageNo=1'>플레어
														스커트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=여성&cmedium=스커트&csmall=롱/맥시 스커트&pageNo=1'>롱/맥시
														스커트</a></li>
											</ul></li>
									</ul>
						...
						<li><a
							href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=none&csmall=none&pageNo=1'>
							...
							<div class="sub_back">
								<div class="sub_menu clearfix">
									<ul class="al_frt1">
										...
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=아우터&csmall=none&pageNo=1'>아우터</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=아우터&csmall=재킷&pageNo=1'>재킷</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=아우터&csmall=점퍼&pageNo=1'>점퍼</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=아우터&csmall=가디건/베스트&pageNo=1'>가디건/베스트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=아우터&csmall=트렌치코트&pageNo=1'>트렌치코트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=아우터&csmall=코트&pageNo=1'>코트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=아우터&csmall=다운/패딩&pageNo=1'>다운/패딩</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=탑&csmall=none&pageNo=1'>탑</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=탑&csmall=티셔츠&pageNo=1'>티셔츠</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=탑&csmall=셔츠&pageNo=1'>셔츠</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=탑&csmall=니트&pageNo=1'>니트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=탑&csmall=스웨터&pageNo=1'>스웨터</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=팬츠&csmall=none&pageNo=1'>팬츠</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=팬츠&csmall=루즈/테이퍼드&pageNo=1'>루즈/테이퍼드</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=팬츠&csmall=슬림/스트레이트&pageNo=1'>슬림/스트레이트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=팬츠&csmall=조거/트랙&pageNo=1'>조거/트랙</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=팬츠&csmall=데님&pageNo=1'>데님</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=팬츠&csmall=쇼츠&pageNo=1'>쇼츠</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li style="margin-right: 0px"><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=수트&csmall=none&pageNo=1'>수트</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=수트&csmall=드레스셔츠&pageNo=1'>드레스셔츠</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=수트&csmall=수트재킷&pageNo=1'>수트재킷</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=남성&cmedium=수트&csmall=수트셔츠&pageNo=1'>수트팬츠</a></li>
											</ul></li>
									</ul>
									<div class="gnb_banner float_right"></div>
								</div>
						...
						<li><a
							href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=none&csmall=none&pageNo=1'>
							...
							<div class="sub_back">
								<div class="sub_menu clearfix">
									<ul class="al_frt1">
										...
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성슈즈&csmall=none&pageNo=1'>여성슈즈</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성슈즈&csmall=부츠&pageNo=1'>부츠</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성슈즈&csmall=로퍼/블로퍼&pageNo=1'>로퍼/블로퍼</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성슈즈&csmall=스니커즈&pageNo=1'>스니커즈</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성슈즈&csmall=플랫&pageNo=1'>플랫</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성슈즈&csmall=힐/슬링백&pageNo=1'>힐/슬링백</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성슈즈&csmall=샌들/슬라이드&pageNo=1'>샌들/슬라이드</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성슈즈&csmall=기타 슈즈&pageNo=1'>기타
														슈즈</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성슈즈&csmall=none&pageNo=1'>남성슈즈</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성슈즈&csmall=부츠&pageNo=1'>부츠</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성슈즈&csmall=포멀슈즈&pageNo=1'>포멀슈즈</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성슈즈&csmall=스니커즈&pageNo=1'>스니커즈</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성슈즈&csmall=샌들/슬라이드&pageNo=1'>샌들/슬라이드</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성슈즈&csmall=기타 슈즈&pageNo=1'>기타
														슈즈</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성백&csmall=none&pageNo=1'>여성백</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성백&csmall=토트백&pageNo=1'>토트백</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성백&csmall=숄더/크로스바디백&pageNo=1'>숄더/크로스바디백</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=여성백&csmall=기타 백&pageNo=1'>기타
														백</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성백&csmall=none&pageNo=1'>남성백</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성백&csmall=토트백&pageNo=1'>토트백</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성백&csmall=숄더/크로스바디백&pageNo=1'>숄더/크로스바디백</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성백&csmall=클러치 백&pageNo=1'>클러치
														백</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=남성백&csmall=기타 백&pageNo=1'>기타
														백</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=머플러/스카프&csmall=none&pageNo=1'>머플러/스카프</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=머플러/스카프&csmall=머플러&pageNo=1'>머플러</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=머플러/스카프&csmall=스카프&pageNo=1'>스카프</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=주얼리&csmall=none&pageNo=1'>주얼리</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=주얼리&csmall=이어링/커프&pageNo=1'>이어링/커프</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=주얼리&csmall=목걸이&pageNo=1'>목걸이</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=주얼리&csmall=팔찌&pageNo=1'>팔찌</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=주얼리&csmall=반지&pageNo=1'>반지</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=주얼리&csmall=기타&pageNo=1'>기타
														주얼리</a></li>
											</ul></li>
										<!--  status2.last end -->
										<li style="margin-right: 0px"><a
											href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=기타 ACC&csmall=none&pageNo=1'>기타
												ACC</a>
											<ul class="clearfix">
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=기타 ACC&csmall=모자&pageNo=1'>모자</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=기타 ACC&csmall=양말&pageNo=1'>양말</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=기타 ACC&csmall=장갑&pageNo=1'>장갑</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=기타 ACC&csmall=벨트&pageNo=1'>벨트</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=기타 ACC&csmall=지갑&pageNo=1'>지갑</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=기타 ACC&csmall=헤어ACC&pageNo=1'>헤어ACC</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=기타 ACC&csmall=테크ACC&pageNo=1'>테크ACC</a></li>
												<li><a
													href='${pageContext.request.contextPath}/product/productlist?clarge=잡화&cmedium=기타 ACC&csmall=기타소품&pageNo=1'>기타소품</a></li>
											</ul></li>
									</ul>
									<div class="gnb_banner float_right"></div>
								</div>
