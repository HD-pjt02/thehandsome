...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "289c8a50-3404-43c6-9404-7ea8ef0646fd";
...
//     var startDate = new Date('2018/03/23 00:00:00'), endDate = new Date('2018/04/08 23:59:59');
    if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
        ...
        var referer = "https://www.thehandsome.com/ko/member/authenticationMail?joincode=13lrTJXIS9UWSpncN8dm,wlgns3882@naver.com";
...
<script type="text/javascript" async="" src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/943253288/?random=1665275403365&amp;cv=9&amp;fst=1665275403365&amp;num=1&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=376635470%2C375603260&amp;u_h=864&amp;u_w=1536&amp;u_ah=824&amp;u_aw=1536&amp;u_cd=24&amp;u_his=1&amp;u_tz=540&amp;u_java=false&amp;u_nplug=5&amp;u_nmime=2&amp;sendb=1&amp;ig=1&amp;frm=0&amp;url=https%3A%2F%2Fwww.thehandsome.com%2Fko%2Fmember%2Fjoinprovision&amp;ref=https%3A%2F%2Fwww.thehandsome.com%2Fko%2Fmember%2FauthenticationMail%3Fjoincode%3D13lrTJXIS9UWSpncN8dm%2Cwlgns3882%40naver.com&amp;tiba=%EB%8D%94%ED%95%9C%EC%84%AC%EB%8B%B7%EC%BB%B4&amp;hn=www.googleadservices.com&amp;rfmt=3&amp;fmt=4"></script><script src="https://cdn.megadata.co.kr/js/socialLink/social_sns_config_min.js" type="text/javascript" defer="" async=""></script><link rel="stylesheet" type="text/css" href="//code.jquery.com/ui/1.12.1/themes/smoothness/jquery-ui.css"><link rel="stylesheet" type="text/css" href="//static.groobee.io/dist/g2/css/grb-recommend-list_v2.css"></head>
...
// 								html.push('<li><a href="http://www.thehyundai.com/front/dpm/myShopHome.thd?bfp=Ref_Handsome">트렌드샵</a></li>');
	...
	<form id="CSRFForm" action="/ko/member/joinprovision" method="post"><div>
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"289c8a50-3404-43c6-9404-7ea8ef0646fd"},
            async : false,
            success:function(data){
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="collection" value="">
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="289c8a50-3404-43c6-9404-7ea8ef0646fd">
			...
			<div class="cnts2_right">
				...
				<div id="newsWrap" class="news">
					...
					<div class="list">
						...
						<ul class="list_new" style="top: -20px;"><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804121237276&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] 한섬살롱 3편 with MINE</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804154070812&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] MUE에서 만나는 피어오브갓 ESSENTIALS</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804154038044&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">핸써미와 함께하는 <br> '한섬 ESG 친환경 정화설비' 탐구</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804154005276&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] 가을을 장식할 한섬 BEST 액세서리</a></li></ul>
					</div>
				</div>
				<!-- //뉴스 -->
				<!-- // 푸터 공지 추가 220404 -->
...
</script><script src="https://cr.acecounter.com/Web/AceCounter_CW.js?gc=AP6F40149814536&amp;py=0&amp;gd=dgc17&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1665275403463" type="text/javascript"></script>
