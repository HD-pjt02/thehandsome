...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "f1ec6a61-8f11-4005-b3e4-77e27a91af9f";
...
//     var startDate = new Date('2018/03/23 00:00:00'), endDate = new Date('2018/04/08 23:59:59');
    if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
        ...
        var referer = "https://www.thehandsome.com/ko/member/login";
...
<script type="text/javascript" async="" src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/943253288/?random=1664894204563&amp;cv=9&amp;fst=1664894204563&amp;num=1&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=375603260&amp;u_h=864&amp;u_w=1536&amp;u_ah=824&amp;u_aw=1536&amp;u_cd=24&amp;u_his=5&amp;u_tz=540&amp;u_java=false&amp;u_nplug=5&amp;u_nmime=2&amp;sendb=1&amp;ig=1&amp;frm=0&amp;url=https%3A%2F%2Fwww.thehandsome.com%2Fko%2Fmember%2Fjoinstart&amp;ref=https%3A%2F%2Fwww.thehandsome.com%2Fko%2Fmember%2Flogin&amp;tiba=%ED%9A%8C%EC%9B%90%EA%B0%80%EC%9E%85%EC%8B%9C%EC%9E%91%20%7C%20%EB%8D%94%ED%95%9C%EC%84%AC%EB%8B%B7%EC%BB%B4&amp;hn=www.googleadservices.com&amp;rfmt=3&amp;fmt=4"></script><script src="https://cdn.megadata.co.kr/js/socialLink/social_sns_config_min.js" type="text/javascript" defer="" async=""></script><link rel="stylesheet" type="text/css" href="//code.jquery.com/ui/1.12.1/themes/smoothness/jquery-ui.css"><link rel="stylesheet" type="text/css" href="//static.groobee.io/dist/g2/css/grb-recommend-list_v2.css"></head>
...
// 								html.push('<li><a href="http://www.thehyundai.com/front/dpm/myShopHome.thd?bfp=Ref_Handsome">트렌드샵</a></li>');
	...
	<form id="CSRFForm" action="/ko/member/joinstart" method="post"><div>
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"f1ec6a61-8f11-4005-b3e4-77e27a91af9f"},
            async : false,
            success:function(data){
...
$(document).ready(function() {
    ...
    if("" != ""){
	    ...
	    if ((vipPassCheck == "Y" || timePassCheck == "Y") && "hsJoinPage" == "main201903Page") {
	        $('#chatbotMain').show(); 
	    }else{
	        $('#chatbotMain').hide(); 
	    }
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="collection" value="">
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="f1ec6a61-8f11-4005-b3e4-77e27a91af9f">
...
$(document).ready(function(){
	...
	*/
    $('#emailAuthBtn').click(function(){
        ...
        if(vc.isValid() && $("#uidDuplChk").val() !='N' ){
            ...
            $.ajax({
                ...
                success: function(data){
                    if(data.resultCode=="S"){
                        ...
                        $("#idDubChkBtn").removeAttr("disabled");
...
<form id="memberJoinForm" action="/ko/member/joinstart" method="POST"><input type="hidden" name="uidDuplChk" id="uidDuplChk" value="" title="이메일 아이디 중복">
                    ...
                    <fieldset>
                        ...
                        <div class="box_type_1">
                            <div class="email ">
                                ...
                                <p class="emailinput">
                                    <input type="text" id="id" name="id" style="width:120px" title="이메일 아이디"> 
                                    <span class="andmail">@</span>
                                    <input type="text" id="uidDomain" name="uidDomain" style="width:120px" title="이메일 계정">
                                    <select id="uidDomainSel" style="width:120px; margin:0 0 0 0;" title="이메일 아이디 도메인">
			...
			<div class="cnts2_right">
				...
				<div id="noticeWrap" class="notice">
					...
					<div class="list">
						...
						<ul class="list_new" style="top: 0px;"><li><a href="/ko/svcenter/notice?noticeCode=8804448915376">10월 연휴(대체공휴일)로 인한 배송지연 안내</a></li></ul>
					</div>
				</div>
				<!-- //공지 -->
				...
				<div id="newsWrap" class="news">
					...
					<div class="list">
						...
						<ul class="list_new" style="top: -40px;"><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804088534812&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">배우 남윤수와 함께한 클럽모나코</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804154038044&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">핸써미와 함께하는 <br> '한섬 ESG 친환경 정화설비' 탐구</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804154005276&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] 가을을 장식할 한섬 BEST 액세서리</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804121237276&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] 한섬살롱 3편 with MINE</a></li></ul>
					</div>
				</div>
				<!-- //뉴스 -->
				<!-- // 푸터 공지 추가 220404 -->
...
</script><script src="https://cr.acecounter.com/Web/AceCounter_CW.js?gc=AP6F40149814536&amp;py=0&amp;gd=dgc17&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1664894204610" type="text/javascript"></script>
...
<script language="javascript" src="https://analysis.adinsight.co.kr/emnet/trs_esc.js"></script>

<!-- adinsight 공통스크립트 end -->



<iframe id="groobeeBox" name="groobeeBox" style="display: none;"></iframe></body></html>