      ...
      <nav class="col-md-2 p-3 h-100 d-flex flex-column">
         ...
         <div class="p-3 border">
            <dl>
               <dt>주문조회</dt>
               <dd>
                  <a class="text-secondary ml-2" href="/member/myorders">주문/배송</a>
               </dd>
            </dl>
            <dl>
               <dt>나의 상품관리</dt>
               <dd>
                  <a class="text-secondary ml-2" href="/member/mycart">쇼핑백</a>
               </dd>
            </dl>
            <dl>
               <dt>쿠폰</dt>
               <dd>
                  <a class="text-secondary ml-2" href="/member/mycoupons">내 쿠폰</a>
               </dd>
            </dl>
         </div>
      </nav>
               ...
               <c:forEach var="orders" items="${orderItemList}">
                  <tr class="row">
                     ...
                     <td class="col border-left">
                        <div class="card border-white" style="max-width: 410px;">
                           <div class="row no-gutters">
                              <div class="col-md-4">
                                 <img class="img-thumbnail" src="${orders.imgurl1}"
                                    alt="...">
                              </div>
                              <div class="col-md-8">
                     ...
                     <td class="col-2 text-center align-middle border-left">￦
                           ${orders.pprice * orders.oamount}</td>
                     ...
                     <div id="pager-container" class="container text-center">
                        ...
                        <c:if test="${page.groupNo > 1}">
                           <a class="btn btn-light btn-sm"
                              href="myorders?type=${type}&keyword=${keyword}&pageNo=${page.startPageNo-1}">이전</a>
                        </c:if>
                        ...
                        <c:if test="${page.groupNo < page.totalGroupNo}">
                           <a
                              href="myorders?type=${type}&keyword=${keyword}&pageNo=${page.endPageNo+1}">다음</a>
                        </c:if>
                        <a
                           href="myorders?type=${type}&keyword=${keyword}&pageNo=${page.totalPageNo}">끝</a>
                     </div>
                     </c:if>
                  </td>
               </tr>
