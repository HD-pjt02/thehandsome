                        ...
                        <td class="align-middle table_detail"
                           ...
                           <div class="d-flex">
                              ...
                              <div style="margin-left: 20px">
                                 <div style="font-size: 11px">${cart_product.bname}</div>
                                 <div>${cart_product.pname}</div>
                                 <div
                                    style="margin-top: 10px; font-size: 11px; color: #999999;">
                                    color : ${cart_product.pcolor} / size :
                                    ${cart_product.psize}</div>
                              </div>
                           </div>
                        </td>
                        <td class="align-middle table_detail"
                           style="width: 66px; text-align: center; border: 1px solid rgba(0, 0, 0, 0.1);">
                           ${cart_product.pamount}</td>
                        <td class="align-middle table_detail"
                           style="width: 158px; text-align: center">₩ <fmt:formatNumber
                              value="${cart_product.pprice * cart_product.pamount}" /></td>
                     </tr>
                  </c:forEach>
               </tbody>
            </table>
               ...
               <table>
                  <tbody class="table_body">
                     <tr>
                        ...
                        <td class="align-middle table_detail">${member.name}</td>
                     </tr>
                     <tr>
                        <th scope="row" class="align-middle table_head"><span
                           class="no_mandatory_sign">* </span>휴대폰</th>
                        <td class="align-middle table_detail">${member.phone}</td>
                     </tr>
                     <tr>
                        <th scope="row" class="table_head align-middle"><span
                           class="no_mandatory_sign">* </span>E-mail</th>
                        <td class="align-middle table_detail">${member.email}</td>
                     </tr>
                  </tbody>
               </table>
            </div>
                              ...
                              <div>
                                 <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                       ...
                                       value="click_pay" onclick="selectPaymentType()" /> <label
                                 ...
                                 <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                       ...
                                       value="virtual_account" onclick="selectPaymentType()" />
                              ...
                              <div>
                                 <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                       ...
                                       value="smile_pay" onclick="selectPaymentType()" /> <label
                                 ...
                                 <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                       ...
                                       value="hyundai_card" onclick="selectPaymentType()" />
                                 ...
                                 <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                       ...
                                       onclick="selectPaymentType()" /> <label
            ...
            <div class="d-flex m-1">
               ...
               <div style="margin-top: 40px; margin-left: 20px">
                  <button type="button" class="btn_normal btn_theme_white"
                     onclick="getBaseAddress(${member.mno})">기본 배송지</button>
               
                  <button type="button" class="btn_normal btn_theme_white"
                     onclick="getAddresses(${member.mno})">최근 배송지 선택</button>
               </div>
               <script>
                  let ano = 0;
                  ...
                  <tbody class="table_body">
                     ...
                     <tr>
                        ...
                        <td class="align-middle table_detail">
                           <div class="d-flex align-items-center">
                              <form>
                                 <select name="phone_number" id="oreceiverphone1_1">
                              ...
                              <div>
                                 <input type="text" size="4" maxlength="4"
                                    id="oreceiverphone1_2" />
                              </div>
                              <div class="form_hyphen">-</div>
                              <div>
                                 <input type="text" size="4" maxlength="4"
                                    id="oreceiverphone1_3" />
                              </div>
                           </div>
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td class="align-middle table_detail">
                           <div class="d-flex align-items-center">
                              <form>
                                 <select name="phone_number" id="oreceiverphone2_1">
                              ...
                              <div>
                                 <input type="text" size="4" maxlength="4"
                                    id="oreceiverphone2_2" />
                              </div>
                              <div class="form_hyphen">-</div>
                              <div>
                                 <input type="text" size="4" maxlength="4"
                                    id="oreceiverphone2_3" />
                              </div>
                           </div>
                        </td>
                     </tr>
         ...
         <div>
            <div>
               ...
               <script>
                  ...
                  let ptype = $('input[name="inlineRadioOptions"]:checked').val();
                  ...
                  function orderSubmit() {
                     let params = {
                           ...
                           "oreceiverphone1" : $("#oreceiverphone1_1").val() + $("#oreceiverphone1_2").val() + $("#oreceiverphone1_3").val(),
                           "oreceivertphone2" : $("#oreceiverphone2_1").val() + $("#oreceiverphone2_2").val() + $("#oreceiverphone2_3").val(),
                     ...
                     for (let key in params) {
                        ...
                        if (key === "oreceiverphone1" && params[key].length < 10) {
