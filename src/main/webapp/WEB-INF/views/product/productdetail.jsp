                        ...
                        <ul class="brd_m cate_m clearfix">
                                ...
                                <script type="text/javascript">
                                    function moveBrandLookBook(brandCode){
                                        ...
                                        $form.append("<input type='hidden' name='CSRFToken' value='77badcd5-86c7-4e47-8c1f-0663967bf7b6' />");
                                        $form.append("<input type='hidden' name='paramBrandCode' value='" + brandCode + "' />");
                                        $form.appendTo('body');
