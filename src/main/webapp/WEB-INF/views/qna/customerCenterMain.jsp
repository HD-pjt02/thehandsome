...
<head>
  ...
  <!-- CSS only -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/customerCenterMain.css" type="text/css" />
    <link
  ...
  <div class="contents">
    <div class="innercon">
      <section class="lnbarea">
        ...
        <ul>
           <li class="lnb-depth1">
            <a href="/qna/customerCenterMain">문의조회</a>
          </li>
          <li class="lnb-depth1">
            <a href="/qna/mtmInqrReg">1:1 문의</a>
          </li>
        </ul>
      </section>
