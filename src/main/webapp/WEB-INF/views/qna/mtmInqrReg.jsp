...
<div id="bodyWrap">
	...
	<div class="sub_container clearfix">
		...
		<div class="sub_cnts">
			...
			<form id="inquiry_insert" name="formm" method="post" enctype="multipart/form-data">
				<fieldset>
						...
						<table class="tbl_wtype1">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="text" id="inquiryTitle" name="qtitle" title="문의제목" class="w_all">
									</td>
								</tr>
								<tr>
									<th scope="row">
...
반품접수는 마이페이지 주문내역에서 “반품 신청“ 버튼을 클릭하여 반품을 접수해주셔야 합니다." maxlength="500"></textarea>
										<!-- //textarea -->
									</td>
								</tr>
								<!-- popup end -->
				...
				<div class="btnwrap">
					<button class="btn wt" type="button" class="btn-cancel" onclick="initializing()">
					  취소
					</button>
					<button class="btn gray mr0" type="button" class="btn-confirm" onclick="go_save()">등록</button>
				  </div>
				</form>
			</div>
	</div>
